...
describe('bricksFactory test', function(){
    ...
    describe('when factory is created (using a mock loader)', function(){
        ...
        it('should have a 2 bricks and they are sorted by desc quantity', inject(function(bricksFactory){

            expect( bricksFactory.length ).toBe( 3 )
            expect( bricksFactory[0].item.itemId ).toBe( 3 )
            expect( bricksFactory[1].item.itemId ).toBe( 1 )
            expect( bricksFactory[2].item.itemId ).toBe( 2 )
